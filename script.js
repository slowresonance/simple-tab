class Bookmarks {
  constructor() {
    ...
    this.configClose = this.getElement("#config-close");
    this.configVariables = {
      "heading-color": "#3e4248",
      "text-color": "#c9d1d9",
      "input-color": "#000000",
  ...
  updateConfig() {
    ...
    for (let variable in this.configVariables) {
      document.documentElement.style.setProperty(
        `--${variable}`,
        this.configVariables[variable]
      );
    }
  }
  ...
  addEventListeners() {
    ...
    this.config.addEventListener("click", () => {
      if (this.configContainer.classList.contains("active")) {
        ...
        this.configClose.classList.remove("active");
        this.config.innerHTML = this.svgConfig;
      } else {
        this.configContainer.classList.add("active");
        this.config.innerHTML = this.svgSave;
        this.configClose.classList.add("active");
      }
    });
